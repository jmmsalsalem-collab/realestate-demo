...
export const translations: Dict = {
  ...
  connectBanner: { en: "Connect your API key in Settings to activate live responses.", ar: "اربط مفتاح API في الإعدادات لتفعيل الردود المباشرة." },
  ...
  connectInline: { en: "Connect your Anthropic API key in Settings to activate live responses.", ar: "اربط مفتاح Anthropic API في الإعدادات لتفعيل الردود المباشرة." },
  ...
  anthropicApiKey: { en: "Anthropic API Key", ar: "مفتاح Anthropic API" },
  apiKeyHelp1: { en: "Your key is stored locally and never sent to our servers. Get a key at", ar: "يُخزَّن مفتاحك محلياً ولا يُرسل إلى خوادمنا أبداً. احصل على مفتاح من" },
